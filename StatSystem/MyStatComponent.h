...
public:	
	...
	FORCEINLINE const float GetHPRatio() { return ((m_CurrentStat.HP) / static_cast<float>(m_CurrentStat.MaxHP));}
	FORCEINLINE const float GetMPRatio() { return ((m_CurrentStat.MP) / static_cast<float>(m_CurrentStat.MaxMP));}
	FORCEINLINE const float GetSPRatio() { return ((m_CurrentStat.SP) / static_cast<float>(m_CurrentStat.MaxSP));}
