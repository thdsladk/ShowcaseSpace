...
#include "TargetActor/Skill/TA_Skill_MultiTrace.h"
...
FGameplayAbilityTargetDataHandle ATA_Skill_MultiTrace::MakeTargetData() const
{
	...
	if (UJWFunctionLibrary::IsDebugMode(SourceActor) == true)
	{
		...
		{
			UJWFunctionLibrary::Debug_ShapeSingleByChannel(SourceActor, HitResult.ImpactPoint, SkillTargetData.CollisionShape.CollisionShape, HitDetected);
		}
	}
